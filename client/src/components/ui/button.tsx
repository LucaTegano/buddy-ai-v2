...
const buttonVariants = cva(
  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-scn-md text-sm font-medium transition-all duration-200 active:scale-95 hover:scale-[1.02] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-scn-ring focus-visible:ring-scn-ring/50 focus-visible:ring-[3px] aria-invalid:ring-scn-destructive/20 dark:aria-invalid:ring-scn-destructive/40 aria-invalid:border-scn-destructive",
  {
    variants: {
      variant: {
